...
RSpec.describe Line do
    ...
    context 'Line Entity ' do
        it "TestCase 1: Two points coincide " do
            ...
            p2=Basicgeometry::Point.new
            p2.setattribute(12,34)
            expect(Line::Straightline.new(p1,p2).findLength()).to eql(0)
        end
        ...
        it "TestCase 2: Two points form a vetical Line " do
            ...
            expect(Line::Straightline.new(p1,p2).findLength()).to eql(56)
        end
        ...
        it "TestCase 3: Two points form a Horizantal Line " do
            ...
            expect(Line::Straightline.new(p1,p2).findLength()).to eql(100)
        end
        ...
        it "TestCase 4: Calculates the Lenght of the Line " do
            ...
            expect(Line::Straightline.new(p1,p2).findLength()).to eql(13.0)
        end
